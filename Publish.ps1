# This script is an interactive publishing tool: its console output (including colour) is the
# user-facing result, so Write-Host is the correct cmdlet here. Since PowerShell 5.0 it writes
# to the information stream, so it can still be captured and redirected.
